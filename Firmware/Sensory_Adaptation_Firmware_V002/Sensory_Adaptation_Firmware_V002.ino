...
void setup() {
  ...
  //while(!SerialUSB);
  SerialUSB.println("Enter a character to start!");
...
void motorA(int percent, int dir) {
  if (dir == 1) {
    ...
    int drive = map(percent, 1, 100, 20, 255);
...
void testMotor() {
  ...
  motorB(0, 0);
  delay(1000);
  SerialUSB.println("30F");
  motorA(30, 0);
  motorB(30, 0);
  delay(1000);
  SerialUSB.println("30B");
  motorA(30, 1);
  motorB(30, 1);
  delay(1000);
  SerialUSB.println("50F");
  motorA(50, 0);
  motorB(50, 0);
  delay(1000);
  SerialUSB.println("50B");
  motorA(50, 1);
  motorB(50, 1);
  delay(1000);
  SerialUSB.println("100F");
  motorA(100, 0);
  motorB(100, 0);
  delay(1000);
  SerialUSB.println("100F");
